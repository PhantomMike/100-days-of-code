...
**Thoughts:** Finally back to some coding.  Glad to finish of jscript and learn more about the DOM and jQuery, I think I have a good basic understanding there.  Also spent time fixing up my codepen learnings web page so it has links to the most important jscript learnings.
...
**Thoughts:** If you want to access a property in an object, and the property name is stored in a variable, then you need to access using square brackets [] after verifying the property exists with hasOwnProperty. Access via the dot operator does not work.
...
**Thoughts:** Have a lot implemented and running, may be enough so I can switch back to FCC javascript tomorrow. We will see, depending on feedback.
